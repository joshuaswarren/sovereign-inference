...
/** The node dashboard, shown once onboarding is complete. Its data fetches only
 * run after the gate in {@link App} mounts this component, so the panels never
 * fire against an unconfigured node. */
